...
function Button.create(text,x,y)
	...
	temp.width = numGame.font["large"]:getWidth(text)
	temp.height = numGame.font["large"]:getHeight()
...
function Button:draw()
	...
	love.graphics.setFont(numGame.font["large"])
	if self.hover then love.graphics.setColor(unpack(color["main"]))
	else love.graphics.setColor(unpack(numGame.color["text"])) end
